						...
						<ul class="nav">
							...
							<li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php if( $_SESSION['admin'] == true ){  
												  echo "adminSettings.php";
												 }else {echo "memberSettings.php"; }?>">Settings</a></li>
				...
				<div class="row">
				  <div class="span12">
					<div class="row">
					  <div class="span4">
						<h4>WELCOME</h4>
						<p><?php echo "<b>".  $_SESSION['username'] ."</b> "; ?>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris.</p>
					  </div>
