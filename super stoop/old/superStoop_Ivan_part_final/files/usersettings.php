		...
		<div class="container register">
			...
			<div class="row">
                <div class="span12">
                	...
                	<p>Welcome, <?php echo "<b>".$_SESSION['username']."</b>!";?>
                		<br />Here, you can view and update your personal account information.</p>
                		<?php
						...
						mysql_select_db( "ischmidt" ) or die ( "Could not select database" );
					...
					<!--ADDRESS-->
						<?php //needs second INNER JOIN address ON address.zip = zipcodes.zipcode
                		$query = "SELECT username, theAddress FROM members 
                				  INNER JOIN address ON members.memberID = address.memberID
						...
						<form class="form-horizontal" action="update_addressinfo.php" method="post">												
							<div class="span4 secondBox">
								...
								<div class="control-group">									
									<?php 
									echo "<p><b>".$row["theAddress"]."</b></p>"; 
									echo "<p><b>".$row["theCity"].", ".$row["theState"]."</b></p>"; 
									echo "<p><b>".$row["zip"]."</b></p>"; 
									?>  
								</div>																										
								<input type="submit" value="Update" />
							</div><!--span4-->
